...
# axiom = "F-F-F-F" #Ковер серпинского
axiom = "F--F--F"     # Сжнежинка коха

l_sys = LSystem2D(t, axiom, pen_width, f_len, angle)
#l_sys.add_rules("F","FF-F-F-F-FF") # Ковер серпинского
l_sys.add_rules(("F", "F+F--F+F")) #Снежинка коха
l_sys.generate_path(5) #кол-во итераций
print(l_sys.state)
